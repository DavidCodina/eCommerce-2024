...
const PageOrders = () => {
  ...
  const { setCurrentOrder, currentOrder, clearCart } = useCartContext()
    ...
    >
      ...
      {currentOrder && (
        <Button
          ...
          // Here cartItems and currentOrder will be cleared,
          // and the logged in user will be redirected to '/store'
          onClick={() => {
            setCurrentOrder('')
            clearCart()
            navigate('/store')
          }}
          title='Clear Current Order & Create A New Order'
        >
