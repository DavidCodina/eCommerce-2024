...
///////////////////////////////////////////////////////////////////////////
//
// While showing user data in an editable form is a quick and easy way
// of displaying and editing it all in one, it's not necessarily the
// the best UI pattern.
//
// Note: This app treats the user as critical data. Consequently, on mount
// AppContext get the current user immediately. Thus it's generally going to be
// ready here immediately. The one important part of this type of implementation
// is we also must remove the user on log out. This is done in MainLayout.tsx.
//
///////////////////////////////////////////////////////////////////////////
...
const PageProfile = () => {
  ...
  const { user, setUser, userStatus, setUserStatus } = useAppContext()
    ...
    if (userStatus === 'error') {
      return (
        ...
        >
          ...
          <p className='text-sm'>Unable to get user info.</p>
        </Alert>
      )
    }
